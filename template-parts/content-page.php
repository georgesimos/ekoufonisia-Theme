...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if ( ! ( isset($post->post_content) && has_shortcode( $post->post_content, 'jobs' ) ) ): ?>
		...
		<?php else:
			if ( !is_page_template( array('page-templates/full_width_no_title.php','page-templates/simos_front_page.php') ) ) { ?>
	...
	<?php endif; ?>
	<?php if ( is_page_template('page-templates/gs-page.php')){ ?>
		<div class="entry-content page-padding" id="entry-content-anchor">
	<?php } else { ?>
